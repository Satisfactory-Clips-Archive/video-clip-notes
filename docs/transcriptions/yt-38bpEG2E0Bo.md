---
title: "November 5th, 2021 Livestream Snutt & Jace Talk: Satisfactory Update 5 Patch Notes vid commentary (Part 49)"
date: "2021-11-05"
layout: transcript
topics:
...
## Snutt & Jace Talk: Satisfactory Update 5 Patch Notes vid commentary (Part 49)
https://www.youtube.com/watch?v=38bpEG2E0Bo
<details>
...
> are two types of train signals block signals and path signals block signals can be placed along the train tracks to create sections of your track where only one train i just want one stop so this this um explaining this like this is one of the this in the vehicles section where two bits that went under like quite a lot of like editing because they can be really complicated uh but we do need to explain it in a way that is correct uh but also really concise yeah uh and so like this is like uh a bit that you know went under the knife quite a bit but uh i think we i think we really nailed it i think this one also ended up being like we we recorded it once and then we cut it up a little bit afterwards as well right even after even in posts so like yeah yeah i think there was one bit that was actually just incorrect too yeah we re-shot you have to record a bit yeah my bit in this video was like incorrect and we didn't realize this until like we were watching like the third draft or something of this trailer and like wait this is yeah correct information because i think we mentioned that like you that you could stop the train from stopping or something like that and that's yeah in the stop settings in the stop settings you could choose whether or not the train would stop or something like that but the trains always stopped incorrect yeah exactly they always don't pass at a time
