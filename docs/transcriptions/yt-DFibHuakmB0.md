---
title: "August 10th, 2021 Livestream Jace Talk: Golf (Part 7)"
date: "2021-08-10"
layout: transcript
topics:
...
## Jace Talk: Golf (Part 7)
https://www.youtube.com/watch?v=DFibHuakmB0
<details>
...
> suppose we can control a specific amount on each output yeah people have suggested that for a while it might be a thing might be a thing there should be a suggestion for it on the qa side already feel free to upload it as as you can see we're very faithful you know when you when you when you guys upload things we add it to the game right away you know once it reaches that threshold it doesn't have to hit 900 by the way you know like ideas don't need to have a lot of votes in fact some ideas can have zero votes and we'll still we'll still take it on board if it's you know if it's a good idea but if it hits 900 votes i mean then we'll just put it in it doesn't matter what it is just needs 900 votes
