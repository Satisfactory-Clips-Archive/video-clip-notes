---
title: "November 5th, 2021 Livestream Snutt & Jace Talk: Satisfactory Update 5 Patch Notes vid commentary (Part 7)"
date: "2021-11-05"
layout: transcript
topics:
...
## Snutt & Jace Talk: Satisfactory Update 5 Patch Notes vid commentary (Part 7)
https://www.youtube.com/watch?v=Z9FAXoysVuc
<details>
...
> i'll be showing off today there will be additional videos with more information so be on the lookout for pretty tired at this point yeah learn more about those things now a lot of features have been requested over on our qa site but by far the fastest growing requested feature on the site has been for us to add the ability to play golf into satisfactory are we actually going to add golf to the game though jace no but we thought in the spirit of things we at least go out and play some real-life golf while we talk about the updates that are coming to the game wow can't wait let's go vomitos ah notice that we didn't say vamanos here because we wanted to save it very important that we didn't say vomit yeah um is it possible by the way on discord uh i can't see what you're showing on stream i see the project is there any way i can also see what you're showing on stream wait oh it's not it's not full screen for you no i can see your timeline and stuff i don't know why that's not happening but okay if it's not easy to fix it's okay we can just roll with it i have no idea what's what it's not showing up it might be that the because i'm using the uh might be something with the uh i don't know yeah okay that's fine yeah that's okay we'll have to worry about it
