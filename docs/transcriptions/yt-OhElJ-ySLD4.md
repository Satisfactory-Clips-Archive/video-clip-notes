...
> [Music]
>
> like there's the summersloops or whatever and we realize that they become broken and we need to make a new item and that means that we need to remove it from the game, or something like that you know that can always happen so, no promises but, if everything works out fine you should be able to use them if you collect them right now maybe
