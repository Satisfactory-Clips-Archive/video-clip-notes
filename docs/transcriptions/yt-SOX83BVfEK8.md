...
> the difference are there physics safeties in place on vehicles i've been doing issues, having issues with multiple loopy loops, there was a thing that i had put on them once but then and it worked but then it didn't work with something else that was happening i think for optimizations purposes and we have to turn it off, which is just, a response that really says nothing at all actually
>
> [Laughter]
>
