---
title: "February 20th, 2019 Livestream Hannah Talk: Level Design Stream (Part 6)"
date: "2019-02-20"
layout: transcript
topics:
    - "environment"
...
> I think let's see if there's anything we're missing it's a for realism steak there isn't a lot of plant life above this cave maybe a little bit here so I'm no roots maybe cuz it's it is a desert so I think we're good also but that one's floating but that is not for me to fix and that's also in a different level
