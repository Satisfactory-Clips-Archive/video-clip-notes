...
> point out that
> update 4 is out on experimental but
> we're still making some tweaks to it and
> there's still some
> minor changes that might come to it i
> just wanted to kind of talk a little bit
