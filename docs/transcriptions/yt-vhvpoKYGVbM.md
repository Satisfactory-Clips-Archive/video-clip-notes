---
title: "November 5th, 2021 Livestream Snutt & Jace Talk: Satisfactory Update 5 Patch Notes vid commentary (Part 13)"
date: "2021-11-05"
layout: transcript
topics:
...
> will have soft clearance any two buildables with hard clearance will not be able to be built clipping into each other just as before however objects with soft clearance will now be able to be built clipping into other buildings this will give players a little more freedom as to how you want to build your fact super pleased with this factory that it's it's doing compact coal on top of the uh coal generators and then feeding it down oh cool which is something that like you couldn't do before and uh then we saw on the the community highlights where somebody built like stacked coal generators that were facing away from each other which is like i would have done that if i had thought about that um but yeah this is pretty similar wait but there might have been an wasn't there an issue actually where you couldn't build you could build you could build things that didn't have complex clearance within the empty space but you couldn't build something with complex clearance in the empty space of something else with complex clearance so like i think even at the time that you were doing what you were making this you probably wouldn't have been able to do it yeah that's a pretty good point too about in general whenever i've been so i've done all the b-roll in this video and the biggest issue when it comes to us making the passions video is that we are literally working on the game as we're producing these videos so it's like really hard to like get final footage of a lot of things because they're still being made um and sometimes a really great example of this is the uh the nuclear pasta yeah you know update four trailers exactly like the that was a work in progress item like they didn't have the the visual effect because like when you're when they were working the game like that's not an important thing right we shouldn't spend it's more important to get the game stable than like fix the vfx for like one of the items in the game that you might not even see right um so i have to like track down people sometimes uh and like really ask them to fix things so that i can get these shots otherwise like the patterns video won't happen yeah and that goes for all the videos leading up to the uh release as well yeah so like smooth has to do that for the passionate stuff but we also have to do that for like the the entire teaser season i guess um where you know we want to put out videos every week but but sometimes it's hard because it's like there's four or five things we want to tease but none of them are ready to be shown and so then we're like oh god what do we do and we have to try and you know problem solve you know that's the ramp railing video right there yeah yeah that's true we had nothing else we could show i was just like how about we make a video about the ramp railings we just make it real over the top we can't show anything else this will buy us a week and and that video came through somehow so yeah
