...
> [Music]
>
> do you have plan at any time in the roadmap to deliver the game on console, same thing with there we we won't look at console until we're done with the game and that's, probably not a good way to do it because most times when you're usually when you port a game you usually want to have console in mind from the start we haven't really done that and that might be that you know we don't want to put out a bad console port either so, but we don't know like I don't want to speculate too much about it honestly because it can't go either way but right now we don't have plans for console at all but it might change in the future once we're settled in
