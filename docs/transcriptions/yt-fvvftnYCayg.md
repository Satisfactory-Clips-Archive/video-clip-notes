---
title: "June 29th, 2021 Livestream Q&A: Native Linux support?"
date: "2021-06-29"
layout: transcript
topics:
    - "technology/linux"
...
> somebody asked about native linux, yeah we answered that before with dedicated service if we have native linux support we don't know but we are interested in it but we'll see if we actually implement it, why can't i religion read my mind it does in unreal engine 5 just reads your mind think of the game you want it just works it just works yeah are we going to get changes to the unreal
