---
title: "September 25th, 2019 Patch Notes Community FYI: I don't see some of my save files in game"
date: "2019-09-25"
layout: transcript
topics:
...
> the game I don't see some of my safe Falls in the game so since a Falls are now associated with your epic account ID you will only be able to see safe files that are associated with set account so if you played on another account on the same computer you need to either log back into that account or move the safe file to the folder corresponding to that epic game epic account that you want to be on why am I seeing duplicates of my
