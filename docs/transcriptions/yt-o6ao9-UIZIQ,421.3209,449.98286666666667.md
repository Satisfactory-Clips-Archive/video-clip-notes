---
title: "April 8th, 2022 Video Jace Talk: Blender (Part 1)"
date: "2022-04-08"
layout: transcript
topics:
    - "coffee-stainers"
...
> most important tool for our 3d artists that they use is called blender blender is a 3d modeling and animation software but it can do much more than just 3d modeling and animation and we use it for game ready low poly 3d models and we also use it for like, uv texture unwrapping and stuff like that uvs are essentially just kind of like how you unwrap your 3d models into a flat surface so that you can paint textures over them and we use blender mostly for inorganic objects so, for example factory buildings in satisfactory another tool
