...
> are the oil patches still in the spire coast yes so the old patches are the old patches that exist will still be there we won't remove any old patches they will be in different locations though throughout aspire coast
