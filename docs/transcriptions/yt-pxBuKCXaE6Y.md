...
> can chainsaw use liquid in the future potentially we the reason why chainsaw only uses like solid biofuel up until now is because the that has that has made sense when you unlock or like rather when we intended to unlock the chainsaw and then further down the line it made sense like maybe to have other fuel and we haven't had that in the game because we haven't solved we haven't had support to like change fuels, for the equipment and that's something that we're probably gonna do in the future I don't know exactly when that will happen, but that's why we haven't had in the game I'm pretty sure we're gonna have it at some point like turbo fuel and chainsaw or you know liquid biofuel which like what else do you use that for, so yeah
