---
title: "March 2nd, 2021 Livestream Q&A: How will Update 4 change the lower-level items?"
date: "2021-03-02"
layout: transcript
topics:
...
https://www.youtube.com/watch?v=7DIFELANBQs
<details>
...
* [January 26th, 2021 Livestream Q&A: Will Update 4 affect the Refinery Recipes outside of Tier 7?](./yt-zYh_QUHwAh4.md) [https://www.youtube.com/watch?v=zYh_QUHwAh4](https://www.youtube.com/watch?v=zYh_QUHwAh4)
...
> how will update 4 changes the lower level lines like motors heavy frames etc so the update 4 will not change anything below tier 7., so all the previous stuff will be the same pretty much there's going to be some things that unlock in earlier, tiers, but we won't change anything like we the thing that we announced is that like in tier seven there's some production, line changes that breaks your save files currently if you already have like production going for your bauxite and your aluminium and, battery production I think are the ones so those will change but the previous ones will be unaffected as far as I know
