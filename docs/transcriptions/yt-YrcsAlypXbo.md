...
> official is the story completely written or is it still in progress the story is completely written like it is it's been done for quite some time, we all right we're gonna start the timer I've got a timer on the screen now okay we won't be, adding the story until 1.0 but the story is finished internally but you guys won't see it for a long time
