...
> will the factory card be his merch I don't think so, it would be cool if if we could make like an actual factory cart like an actual working factory cart that would be amazing, right now like there is a factory card shirt that you can get, one merch will become available, that's in the plans but no like physical factory card yet radio car oh my god rc factory car that's such a good idea holy if somebody finds like a a good merch store that does these type of things like I haven't even seen this for rockerly like an rc car like that please hit me up if you find something like that
