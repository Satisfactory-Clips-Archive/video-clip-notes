---
title: "November 2nd, 2021 Livestream Q&A: Will the save times be reduced?"
date: "2021-11-02"
layout: transcript
topics:
...
* [July 13th, 2021 Livestream Q&A: Quicker Autosave, please?](./yt-cIhVRJPmBoc.md) [https://www.youtube.com/watch?v=cIhVRJPmBoc](https://www.youtube.com/watch?v=cIhVRJPmBoc)
* [March 30th, 2021 Livestream Q&A: Faster autosaves?](./yt-V1HcV3g7ELg.md) [https://www.youtube.com/watch?v=V1HcV3g7ELg](https://www.youtube.com/watch?v=V1HcV3g7ELg)
* [February 2nd, 2021 Livestream Q&A: Is there a way we can make Autosave more seamless?](./yt-UFWTP8Nu-MI.md) [https://www.youtube.com/watch?v=UFWTP8Nu-MI](https://www.youtube.com/watch?v=UFWTP8Nu-MI)
...
> will the save times be reduced we'll do what we can to sort of reduce them but like ultimately with this kind of game where it is like an infinitely building infinitely scaling game, a reality is that the save times will kind of just get kind of long but we'll do what we can to make it a bit a bit better so we've always wanted to improve the save time and we have like a couple of ideas what we can do to fix it but, it's it's there are always like things that sort of get in the way we would only be moving the goal posts you know which is still okay like like any benefit we can we can have is still better than you know better than nothing but like you know if we half the the time that you know it takes to save you'll get back up to that same time amount of time and again anyway so yeah eventually but yeah
