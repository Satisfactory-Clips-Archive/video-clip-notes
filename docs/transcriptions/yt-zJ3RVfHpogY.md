---
title: "February 23rd, 2021 Livestream Q&A: Is DirectX 12 fully supported now?"
date: "2021-02-23"
layout: transcript
topics:
    - "technology/directx"
...
> is your xx12 fully supported now hell no I'm so sorry I didn't mean to sound so derogatory, no the directx 12 thing that we put in the experimental build that was just as like a test to see how bad it is and it was worse than we thought kind of, I don't know if we will we will ever, support it honestly because, it just didn't work that well at all like that was kind of why we tested it just to see like the potential of it and it's not looking great with the current way we've made the game, so there's a lot of work we need to put in to support directx 12.
