...
> was there battle royale mode planned no albeit you could make your own battle rap mode if you if you want to somebody should make a mod so that it like like it's kind of doable right now we did that as like a first stream we ever streamed the game um we kind of had like a battle royale arena thing but yeah it would be dope if kind of i don't know how that would work would you craft your own stuff then please not no we're not gonna do anything efficient with that
