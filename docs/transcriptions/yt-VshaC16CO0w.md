...
> yeah steam yeah someone's asked about a steam workshop on this topic we don't know yet what we're gonna do with that, the important thing for us is to we have a modding community that you know live in their their little environment we don't want to mess that up for them so if it means like if we start adding steam workshop support then will that make it so that people on epic suffer because they won't have access to that, we we want to support both platforms that we're on, to the best of our capabilities and any future platforms if you know we decided to sell elsewhere as well you know so we don't want to we don't want to just you know lock mods off to steam only but the thing is like people who want to know like like they're they're mods are available for satisfactory like there aren't there isn't official mod support but what the folks are doing in the unofficial modding community like if you want mods they're there and the tools that they've developed are insanely convenient so, yeah if you want mods they're they're right there there's a lot there there's a lot of people making mods, the entire community fix it thought if you're if you want to check it out by the way fix it dot app, that's like a good hub of all the mods the tools that you need to use them are there the tools are really easy to use oh that wasn't fast enough
