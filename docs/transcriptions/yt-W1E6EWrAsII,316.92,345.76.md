---
title: "June 22nd, 2018 Q&A Q&A: Is the Map procedurally generated?"
date: "2018-06-22"
layout: transcript
topics:
...
> about it is the map procedurally generated will there be procedurally generated resource locations there will be nor procedurally generated maps or resources I have no idea if that's something that's going to change in the future or not a lot of people have expressed some concerns that if there is no procedural generation there will be no replayability but please understand that we have kept replayability in mind during development and we have some plans for it but of course we're still welcome to suggestions especially suggestions that don't require procedural generation will you
