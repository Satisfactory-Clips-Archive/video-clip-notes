---
title: "November 5th, 2021 Livestream Snutt & Jace Talk: Satisfactory Update 5 Patch Notes vid commentary (Part 33)"
date: "2021-11-05"
layout: transcript
topics:
...
## Snutt & Jace Talk: Satisfactory Update 5 Patch Notes vid commentary (Part 33)
https://www.youtube.com/watch?v=baA6Zs8fq1I
<details>
...
> saved routes can only be loaded by vehicles of the same type also routes now need to be a closed loop meaning that they start and end on the same node truck stations have also gotten an update it's got a new model and we've added another input and output slot so the throughput has doubled also fuel consumption at truck stations is now a lot smarter as vehicles will only take and consume the amount of fuel needed to complete a full loop a lot also also for the truck station also also that is such a trip there are a couple of times where like when we were writing the script or like we just noticed that like dude we keep saying this over and over again yeah i guess we missed this one yeah i guess so because like even when recording it it's not like i do all this all in one take right so i do you know something a bunch and then you know see i don't really hear them in um you know one after the other so it's hard to catch sometimes also sometimes it's kind of tricky because sometimes when you're recording it might not be in the script but but it like when you're talking it feels natural to say it in a specific way and like one of this is like one of those things where it may it feels better for me to start saying also in the beginning of this segment and then you don't notice that like oh i've done it three more times already yeah because it because it's awkward to just start speaking about something sometimes but like you need to try to keep the context in mind like how it's going to be edited but it's sometimes just hard to to remember additional information such as average
