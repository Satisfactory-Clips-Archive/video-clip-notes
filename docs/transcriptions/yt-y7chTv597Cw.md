...
> better but smirking asking for the for the map oh there's do we have maps important in this yeah there it is there you go okay here's the map, no we didn't have we didn't have this so this map here is a placeholder map because it doesn't actually do anything it just
>
> [Laughter]
>
