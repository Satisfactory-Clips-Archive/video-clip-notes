...
> someone asking if mods will come to update for it, so we don't actually officially support mods so we don't we don't release any mods ourselves right now we do what we can to help the current, unofficial modding community, to do it yeah, but we will the plan in the future is to have like a more official mod support yeah, yeah and like some easy way to install mods or whatever how we support that but whatever however that works well yeah later whatever later
