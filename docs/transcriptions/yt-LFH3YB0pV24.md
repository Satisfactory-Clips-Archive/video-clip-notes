...
> walls and handrails be able to place like pipes, place once extend the desired length, yeah it's not impossible it's it's an ongoing discussion kind of how we should handle that, we have a we have a plethora of of ideas on how to deal with that but nothing has been decided concretely yet but we hear you we hear you
