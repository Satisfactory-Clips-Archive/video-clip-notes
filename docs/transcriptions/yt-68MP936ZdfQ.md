...
> are you considering a train where you work we've sort of already confirmed that we will be adding like a collision with trains at some point yeah, so that yes there will be there will be train rework, will there be a better alternative to trains if there is I can't say if there isn't then there isn't yeah we've always wanted to redo the trains eve like eve I think even in the launch video for or like tight some some video that came right after the patch notes video for trains I believe we said like we definitely want to do more with trains, but this is like the first iteration of trains so that's something we wanted to do for a long time
