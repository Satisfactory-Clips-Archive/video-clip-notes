...
> let's see how long before the oil area rework it's not the next update it is not in update five so that you're talking about the spire coast that's getting a major update, that is not coming in update five I don't know when it's coming but any world changes beyond update five will not be coming this year okay so it's it's certainly not coming this year it is the understanding
