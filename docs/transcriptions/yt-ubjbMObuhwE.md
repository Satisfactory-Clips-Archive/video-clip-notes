...
> update five had a lot of changes the caves right yes and there will be more updates to cave in update six because like we mentioned in update five the changes to caves will roll out and it's gonna be the same case with update six for a lot of things including caves yes
>
> [Music]
