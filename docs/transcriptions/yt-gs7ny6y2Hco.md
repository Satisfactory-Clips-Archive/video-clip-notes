...
> is no, how do you determine how much a part of the game is influencing multiplayer that's a tough one do you mean performance wise or is it like decision making when we pick like what we fix or because there is a there's a balance of when we decide like how much resources as in people working on the game that work on multiplayer stuff performance okay, yeah it's right now it's it this goes back and forth a little bit it depends where we are in production right now it's like we've assigned like a few people working on nothing but performance and
>
> [Music]
>
