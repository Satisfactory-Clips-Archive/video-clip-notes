...
> let's see uh can we blend lizzy doggers in the new blender uh obviously i can yeah i can you gotta use the special command secret command to blend the doggo turns the blender red yeah the command is to pick up the lizard doggo and put it in yep slash pickup
