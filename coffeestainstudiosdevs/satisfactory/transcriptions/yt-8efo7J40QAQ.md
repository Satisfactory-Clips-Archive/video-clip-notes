...
> will we ever be able to snap water extractors to each other i don't know maybe hopefully we'll see we have actually looked into that and uh i don't know if we've uh it's a little bit trickier because they the snapping works very differently in those cases so we'd have to make like a separate system for that so we'll see i don't know
